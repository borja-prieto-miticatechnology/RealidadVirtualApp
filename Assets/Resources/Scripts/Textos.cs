...
public class Textos : MonoBehaviour
{
    ...
    public static string texto5 = "Ahora vamos a coger algunos objetos. Localiza la silla amarilla y recogela presionando el gatillo trasero del mando";
    public static string texto6 = "¡Perfecto! ¡Ya lo tienes! Empecemos con la formación";
    public static string texto7 = "Abre y cierra la tablet pulsando el boton de menú y utiliza los botones para interactuar con el medio. Cuando haya terminado avance a la formación 2 a través del botón Empezar prueba.";
    ...
    public static string texto9 = "¡Atención! Ha saltado la alarma de deteccion de humos. Sigue las instrucciones para llevar una correcta ejecución del plan de seguridad del edificio.";
    public static string texto10 = "Localiza la mascara de oxigeno y cogela";
