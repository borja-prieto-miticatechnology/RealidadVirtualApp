namespace VRTK.Examples
{
    ...
    public class VRTKExample_PointerObjectHighlighterActivator : MonoBehaviour
    {
        ...
        public Text elementoSeleccionado;
        public GameObject canvas;
        public GameObject cartel;
        public GameObject siguiente5;
        public GameObject siguiente6;
        public GameObject siguiente9;
        ...
        protected virtual void DebugLogger(uint index, string action, Transform target, RaycastHit raycastHit, float distance, Vector3 tipPosition)
        {
            ...
            if(raycastHit.transform.tag == "hud")
            {
                ...
                siguiente5.gameObject.SetActive(true);
                textoCartel.text = Textos.texto6;
            }

            if (raycastHit.transform.tag == "o2")
            {
                imagenHUD.gameObject.SetActive(false);
                imagenO2.gameObject.SetActive(true);
                raycastHit.collider.gameObject.SetActive(false);
                canvas.gameObject.SetActive(true);
                cartel.gameObject.SetActive(true);
        ...
        {
            guias.gameObject.SetActive(true);
            canvas.gameObject.SetActive(false);
            cartel.gameObject.SetActive(false);
